...
export const introDownload = {
  label: "Or download the Studio Baggio introduction",
  footerLabel: "Studio Baggio introduction (PDF)",
  href: "/downloads/studio-baggio-introduction.pdf"
};
  ...
  items: [
    {
      ...
      body:
        "The contact form asks for your name, email address, company name and website. You can also add optional context about the challenge, what you have tried, why now matters and what success would look like."
    },
    {
...
export const servicesPage = {
  ...
  offers: [
    ...
    },
    {
      ...
      paras: [
        "For businesses that want more new and repeat revenue from their expertise, relationships and existing client base.",
  ...
  download: {
    ...
    title: "Download the Studio Baggio introduction",
    body: "The full introduction to these services, with examples and results, as a shareable PDF.",
    label: "Download the introduction (PDF)"
  },
  faq: {
