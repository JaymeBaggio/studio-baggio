...
export const insightArticles: InsightArticle[] = [
  {
    slug: "how-to-build-an-ai-literate-business-in-90-days",
    title: "How to build an AI-literate business in 90 days",
    category: "AI Adoption",
    categorySlug: "ai-adoption",
    tags: ["AI literacy", "AI adoption", "90 days", "AI operating system", "AI strategy", "AI skills", "Ideas Fest"],
    faq: [
          {
                "question": "How do you decide where AI will create commercial value?",
                "answer": "There are hundreds of things you could improve, but that's the case with or without AI. It's about which one gives you the highest leverage. If I need to bring in more clients, then my best application of AI is bringing in more clients. How can we use it to achieve that? The question you're asking is the same whether or not AI is included in the conversation. You're far more likely to be successful applying AI to a particular problem than trying to create hundreds of workflows that don't fit together and don't achieve what the business actually needs."
          },
          {
                "question": "What should a CEO personally do on Monday?",
                "answer": "You're the CEO. You cannot lead on AI from the sidelines. Spend one working day using it alongside your own work. Write an email with it. You probably won't like the first version, so show it examples of how you write. Ask it for a report and show it what your reports normally look like. See how far you can push it. It might feel painful at first. You need to understand what this feels like for your employees. Record how you felt, what worked and what didn't. Then, on day two, look at your strategic priorities and ask AI to help you work out where it could help you achieve them. If you don't know where to start, ask it."
          },
          {
                "question": "Do employees actually need AI training?",
                "answer": "People really overcomplicate this. If you've put a proper setup in place, employees won't need a separate AI-training programme or to understand how it all works underneath. There are fundamentals they need to know, including that the output can be wrong and what they can or can't put into the system. Your team are domain experts in their own fields. They should be teaching the AI what they do, how to do it well and what good looks like, then using it to expand what they're capable of doing within their role. A lot of the understanding comes through use. If you don't know how to do something, ask the AI. It can walk you through what to do next. People often just need reminding of that."
          },
          {
                "question": "How do you know whether it is working?",
                "answer": "I'd measure the bottom line in exactly the same way you do now. Is this use of AI making us more money, or is it saving us money? If you can't answer either of those, have a think about where your focus is. It should also be generating additional value for your clients: finding new ways to do something better, or new ways to partner with others in your industry. Those are the areas where AI can unlock another level for a business. If you're streamlining responses to emails, is that the thing that's going to unlock additional revenue right now? That's the question I'd be asking."
          }
    ],
    source: "Studio Baggio original",
    sourcePath: "/Users/jaymebaggio/Desktop/Studio Baggio/Press/Ideas Fest 2026/linkedin-doc/build.py",
    sourceStart: "Start with the business strategy. Identify the biggest constraint or opportunity, then work backwards into where AI can help.",
    readTime: "9 min read",
    date: "2026-09-20",
    updated: "2026-09-20",
    summary: "Start with the business constraint, not AI. Build a system that’s designed for people to win from the outset. Measure business outcomes, not adoption.",
    preview: "Start with the business constraint, not AI. Build a system that’s designed for people to win from the outset. Measure business outcomes, not adoption. Nineteen questions businesses ask most about AI, and how I’d advise on each one, in the order the 90 days run.",
    thesis: "By day 90, you should be able to point to important work that is now being done differently and producing a better business outcome.",
    metaTitle: "How to Build an AI-Literate Business in 90 Days | Studio Baggio",
    metaDescription: "Nineteen questions businesses ask most about AI, answered in the order the 90 days run: where to start, what a CEO should do on Monday, what an AI operating system looks like, and how to know it is working.",
    related: [
      "ai-set-up-guide",
      "3x-documents-10x-ai-effectiveness",
      "how-to-master-seo-ai-search-2026"
    ],
    sourceMarkdown: "# How to build an AI-literate business in 90 days\n\n## Days 1 to 30: understand and prioritise\n\nStart with the business strategy. Identify the biggest constraint or opportunity, then work backwards into where AI can help.\n\n### How do you decide where AI will create commercial value?\n\nThere are hundreds of things you could improve, but that's the case with or without AI. It's about which one gives you the highest leverage. If I need to bring in more clients, then my best application of AI is bringing in more clients. How can we use it to achieve that?\n\nThe question you're asking is the same whether or not AI is included in the conversation. You're far more likely to be successful applying AI to a particular problem than trying to create hundreds of workflows that don't fit together and don't achieve what the business actually needs.\n\n### We've bought licences and done training. What should change in 90 days?\n\nYou're doing well, but you're focused on adoption rather than application, which is where most businesses struggle. I'd start with the business constraints and opportunities. If you need to generate more leads, focus on finding ways you can be using AI to do that. If you need to hire more of the right people, use AI to help find and qualify candidates.\n\nThen set the system up so your teams can win from the outset. Give it the shared company context, then bring in the department and role context. Get people turning their specialist knowledge and templates into skills they can use in their work. Focus on the things the business needs to achieve. Adoption will be a byproduct of that.\n\n### What is the biggest mistake businesses make?\n\nOvercomplicating this and losing focus on the business. Business strategy and growing a successful company are still exactly the same as they were before. We now have better tools to help us to achieve our business goals.\n\nWhat are the business constraints? Where can you apply AI to generate more revenue, accelerate growth, add more value, deliver faster? Spending your time making sure everybody can prompt perfectly isn't the priority. Having a shared direction, then understanding where AI can give you an advantage in getting there, is.\n\n### What should a CEO personally do on Monday?\n\nYou're the CEO. You cannot lead on AI from the sidelines. Spend one working day using it alongside your own work. Write an email with it. You probably won't like the first version, so show it examples of how you write. Ask it for a report and show it what your reports normally look like. See how far you can push it.\n\nIt might feel painful at first. You need to understand what this feels like for your employees. Record how you felt, what worked and what didn't.\n\nThen, on day two, look at your strategic priorities and ask AI to help you work out where it could help you achieve them. If you don't know where to start, ask it.\n\n### If the workflow is bad, don't you just make a bad process faster?\n\nIt's just as important to understand what you shouldn't automate. Putting AI into a business forces you to think about which processes you actually need. If everything's in somebody's head, it's going to be messy, and some of those processes can be cut out entirely.\n\n### What about data, risk and governance?\n\nI'd push back on that question slightly. I think there's been a lot of fearmongering around data and risk. For example, the enterprise versions of Claude and ChatGPT don't use your business data to train their models by default. You still need to understand the rules around what data you can put into them.\n\nBut I think some people are using the risk angle as a shield for what they're actually feeling: overwhelm. \"It would take far too long to map our workflows. I don't know where to start.\" I'd bring it back to the business constraints and opportunities and work from there.\n\n### What should businesses buy, build or ignore?\n\nDon't start by buying a stack of specialist tools. Start with the business problem and use a capable general-purpose model as the base. Give your team the ability to build the tools they need specifically for your business.\n\nYes, that costs money in AI tokens. But you're building something around your people and your work, instead of buying a tool because it's the latest hype. I'd speak to an expert about the setup, but there are very few tools on the market that I think are necessary right now.\n\n## Days 31 to 60: experiment and build capability\n\nYour employees are already the domain experts. Give the AI the business and role context, then let your people teach it what good looks like.\n\n### What does an AI operating system actually look like?\n\nIf you're an employee at a company and they've put a solid system in place, the AI you work with knows who you are, what you do, what your goals are and where you fit into the wider vision of the company.\n\nThat means giving it the company context first, then the department and role context. When you start using it, it already has an understanding of the bigger picture. You can then bring in your specialist knowledge and show it how you do your work. The setup should make it possible for the things you create and the corrections you make to help the wider team too.\n\n### Can you give one concrete example of something you've built?\n\nI built a system for a non-technical team and deliberately made it so it would grow with them and compound over time. It knows it's working with people who aren't technical, so it nudges them: \"Should I make this a repeatable skill? Should I add this to the shared work?\"\n\nIf there's already a similar template, it can flag that: \"We've got a duplicate here. Which one should take precedence?\" And if somebody corrects it, it's set up to update the skill. The team don't have to understand how all of that works underneath. They can do their work, and the system is designed to pick up the things that will make it better for them next time.\n\n### How do you get beyond the enthusiastic early adopters?\n\nYou set the system up for your teams to win from the outset. It should already understand the company, their department and what they do.\n\nI'd encourage employees to find the opportunities themselves. How can they use it to strengthen what they're already great at and do things they couldn't do before?\n\nYou'll see certain members of the team really shine. Those are the people I'd champion and encourage to share what they're learning with the wider group. Adoption comes from people seeing what they can actually do with it.\n\n### Do employees actually need AI training?\n\nPeople really overcomplicate this. If you've put a proper setup in place, employees won't need a separate AI-training programme or to understand how it all works underneath.\n\nThere are fundamentals they need to know, including that the output can be wrong and what they can or can't put into the system. Your team are domain experts in their own fields. They should be teaching the AI what they do, how to do it well and what good looks like, then using it to expand what they're capable of doing within their role.\n\nA lot of the understanding comes through use. If you don't know how to do something, ask the AI. It can walk you through what to do next. People often just need reminding of that.\n\n### If everybody experiments, won't you get 200 disconnected workflows?\n\nThat's why I keep coming back to the foundations. My own setup is deliberately built to detect duplication. If I want to add a skill and there's already one doing something similar, it can look at whether the one new element would strengthen the original skill, and add that there.\n\nI've built that into the setup because I want it to grow without becoming cluttered. The shared company context also needs a solid understanding of the wider business strategy. People can experiment in their own departments, but everything should be pulling in the same direction.\n\n### What do you mean by building around your best people?\n\nYour people are the domain experts. I'd give each person the task of turning their specialist knowledge and templates into skills the team can use.\n\nThat can be as simple as showing ChatGPT three versions of a pitch deck and asking it to help turn that process into a set of skills, from the insights to the copy to the finished deck. Then, as people use it and correct it, those skills can improve. You're giving more of the team access to the things your best people already know how to do well.\n\n## Days 61 to 90: embed, measure and scale\n\nMeasure the work, not the adoption. Is it generating revenue? Saving money? Improving output? Delivering something sooner? Removing a real constraint?\n\n### How do you know whether it is working?\n\nI'd measure the bottom line in exactly the same way you do now. Is this use of AI making us more money, or is it saving us money? If you can't answer either of those, have a think about where your focus is.\n\nIt should also be generating additional value for your clients: finding new ways to do something better, or new ways to partner with others in your industry. Those are the areas where AI can unlock another level for a business. If you're streamlining responses to emails, is that the thing that's going to unlock additional revenue right now? That's the question I'd be asking.\n\n### What does an AI-literate business look like?\n\nIt's very obvious when you see it. The whole business will just be working in a different way. People will feel like they've unlocked another level of what they're capable of, and they'll be excited to explore things they couldn't touch before. Your employees don't need to know all the terminology or the underlying setup. They need to understand what's possible, what's worth doing and what isn't.\n\n### What should humans still be doing?\n\nIn the first 90 days, very little should be entirely handed over to AI. Those first 90 days are about putting in place a system that compounds with you.\n\nIf somebody changes a shared template while they're doing a task, the AI should nudge them about whether that change should be part of the shared template going forward. That's where I want your best people's judgement involved. I'd certainly still have people judging what gets sent to a client.\n\nBy the end of the three months, some processes should already be automated as part of a larger workflow. Others shouldn't be there at all. Before automating a whole process, I'd ask whether it's worth having in the first place.\n\n### What should good actually look like by day 90?\n\nYou can achieve a lot in 90 days. Give people the freedom to experiment, with the foundations in place so those experiments don't turn into a complicated system.\n\nI'd expect an energised workforce who produce higher-quality work and push themselves in the direction they want to go.\n\nYou won't have a workforce of developers. That's not what anybody needs. You'll have people who feel they've unlocked a way to get more from the work they're doing, with a system that grows as they do.\n\n### Isn't this just sophisticated knowledge management?\n\nFive years ago, documenting your best people's processes would have meant making a Word document that somebody had to follow manually. That one document could be interpreted 500 different ways, depending on how many people were in your company.\n\nIt doesn't understand the wider business, what each department contributes or how somebody's role affects the work. It doesn't grow as the team grows or as the business changes.\n\nWith AI, you can build a shared capability that your best people contribute to, that understands that context and keeps developing as people use it. It can adapt to what different departments need. That's a very different thing from having a fixed process in a Word document.\n\n### Doesn't teaching AI create extra work for senior people?\n\nIt shouldn't feel like a separate workload. They shouldn't be starting from scratch.\n\nTaking two minutes to correct something or give another example is worth doing because that correction can improve the way the system works next time. Think of it like training a new employee. If you had an executive assistant, you'd take the time to say, \"I prefer my Outlook emails to sign off like this.\"\n\nThe system should be set up to retain that correction. You're taking a couple of minutes while doing the work to make the thing you'll be working with every day more useful to you.\n\nBy day 90, you shouldn’t be impressed that the company “uses AI”. You should be able to point to important work that is now being done differently and producing a better business outcome."
  },
  {
  ...
  {
    slug: "how-to-master-seo-ai-search-2026",
    title: "How to master SEO & AI search in 2026",
    category: "AI Search",
    categorySlug: "ai-search",
    tags: ["AI SEO", "GEO", "AI search", "SEO 2026", "ChatGPT recommendations", "AI visibility", "AI answers"],
    faq: [
      {
        question: "What is AI SEO (GEO)?",
        answer: "AI SEO- also called GEO, AEO or AI search visibility- is the work of getting your business named inside AI answers on ChatGPT, Perplexity and Google's AI results. The labels all describe the same thing."
      },
      {
        question: "How do AI assistants choose which businesses to recommend?",
        answer: "The AI runs searches, reads what already ranks- content, rankings, directories, press, reviews, \"best of\" lists- and decides which to select, cite and name. It favours pages that carry proof and authority signals (E-E-A-T: named authors, credentials, real people), names it can verify in more than one place, and details that stay consistent across the web."
      },
      {
        question: "Does traditional SEO still matter in 2026?",
        answer: "Yes. AI builds its answers from what already ranks in search- Google for some engines, Bing for ChatGPT- so everything you have done to rank is the raw material for AI answers. None of that work is wasted."
      },
      {
        question: "How do I check whether AI recommends my business?",
        answer: "Ask ChatGPT and Perplexity the questions your buyers would ask- \"who's the best [what you do] in [your city]?\"- and log whether your name comes up. Repeat monthly; the gaps are your to-do list."
      }
    ],
    source: "Studio Baggio original",
    sourcePath: "/Users/jaymebaggio/Desktop/Studio Baggio/Content/How businesses get found in 2026/AI_Search_Plain_English_Guide.md",
    sourceStart: "58% of consumers have already replaced traditional search engines with AI",
    readTime: "5 min read",
    date: "2026-08-09",
    updated: "2026-08-10",
    summary: "58% of consumers have already replaced traditional search engines with AI when deciding what to buy and who to use (Capgemini).",
    preview: "58% of consumers have already replaced traditional search engines with AI when deciding what to buy and who to use (Capgemini). Your next client is more than likely one of them- asking ChatGPT who they should choose instead of scrolling through a list of links on Google.",
    thesis: "The firms named in AI answers are the ones the public web agrees on.",
    metaTitle: "How to Master SEO & AI Search in 2026 | Studio Baggio",
    metaDescription: "58% of consumers have replaced search engines with AI. How AI answers get built, why AI-referred visitors convert at 4-5x a normal website, and how to get your business named.",
    related: [
      "generative-engine-optimisation",
      "ai-set-up-guide",
      "firecrawl-for-business"
    ],
    sourceMarkdown: "# How to master SEO & AI search in 2026\n\n58% of consumers have already replaced traditional search engines with AI when deciding what to buy and who to use (Capgemini). That number is expected to grow to 75% by 2027. Your prospective clients are more than likely one of them- asking ChatGPT who they should choose instead of scrolling through a list of links on Google.\n\nThe industry calls getting into those answers GEO, AEO, AI SEO or AI search visibility- These are all essentially the same thing. Ignore the jargon.\n\n> **Try it yourself** → open ChatGPT and ask \"who's the best [what you do] in [where you're based]?\"\n\nIf your name comes up- that's a major advantage- If it doesn't, that's fixable- and simpler than you might think…\n\n## What happens when you ask AI to recommend?\n\nSay a business owner types this into ChatGPT → \"Who's the best financial adviser for business owners in London?\"\n\nThe AI runs a selection of searches on your behalf- then reviews the content, rankings, directories, press, reviews, \"best of\" lists that come up. It then decides which is best to select, cite and name in the answer.\n\n6 x key points that factor into that decision:\n\n**Relevance.** What makes the biggest difference is focusing on providing value to a customer or client. Providing useful resources that answer key questions they want answered is the No1 differentiator here.\n\n**Evidence and Authority.** Google calls this E-E-A-T (experience, expertise, authority, trust). Named authors with real credentials, an about page with real people, qualifications and dates on the page. Claims should be supported by real evidence and named sources.\n\n**Consistency.** Is your name, expertise & offering described consistently across the web? If your services match everywhere, you're easy to recommend. If they clash, it won't be able to trust sources.\n\n**Accessibility.** Can search engines find, crawl, index and clearly understand the relevant page?\n\n**Sources.** Perplexity and Google's AI answers draw almost entirely from what ranks on Google, ChatGPT also searches through Bing and references Yell- they also pull heavily from Reddit and LinkedIn too.\n\n**Corroboration.** AI favours names it can verify in more than one place. Credible external sources should confirm what your website says about you. Backlinks & third-party mentions help too.\n\n## Why AI Search is so effective: prospects come in pre-qualified\n\nA visitor from Google clicked a link. A visitor from an AI answer had a conversation first- they asked about fees, fit, alternatives and their specific circumstances, and the AI recommended you by name.\n\nThat is a referral, not blind traffic. By the time they land on your site they're most of the way to a 'yes'.\n\nA normal website converts 1-2% of visitors. Businesses tracking AI-referred visitors report 4-5 times that.\n\nAnd barely anyone is doing this yet. In finance, the average Firm gets cited in less than 2.1% of AI answers (Boring Marketing).\n\nWhen we tested 50 buyer questions about the UK financial adviser market across Chat GPT, Perplexity & Google- producing 450 AI answers- [93 of the UK's top 150 financial advice firms were totally invisible in AI search](/research/uk-financial-advice-2026). Those that are getting this right hold a lot more power than the rest, regardless of their credentials.\n\n## How to get named\n\n- Answer real questions on your site → plainly, near the top of the page. AI quotes clean, self-contained answers. Buried points never get read.\n\n- Be specific and name your sources → \"Many firms see results\" gets skipped. A named figure from a named source gets quoted.\n\n- Make it readable by machines → clear headings, descriptive URLs and internal links. Add pages to your sitemap, use Google Search Console to index them. Add FAQs, schema and breadcrumbs to make it findable and readable- these are labels that tell AI what each part of your site is- ask Claude or Codex to add them for you.\n\n- Get mentioned in places you don't own → backlinks and third-party mentions are important- press, directories, roundups, reviews, Reddit and independent lists all corroborate what your own pages say. Ahrefs studied 75,000 brands and found mentions track AI visibility 3x more closely than backlinks.\n\n- Keep your details consistent everywhere → same name, same description, same services across your site, LinkedIn, your Google Business Profile and every listing. For local searches the AI leans heavily on your Google Business Profile and its reviews- keep both current.\n\n- Check monthly → test the same buyer questions each month across ChatGPT, Gemini and Perplexity in incognito mode. Record whether you are named, cited or absent, which pages are used, and the date. Use Search Console to monitor Google visibility and indexing.\n\n## How to start:\n\n1. Write down ten questions prospective clients ask before choosing someone like you. Go to Perplexity and ask \"who's the best [what you do] in [your city]?\" (free at perplexity.ai)- under each answer it lists the related questions real people ask.\n\n2. Test them across ChatGPT, Gemini and Perplexity and record the current answers.\n\n3. Choose the most commercially important gap.\n\n4. Improve or create one genuinely useful page that answers it with specific evidence.\n\n5. Link to it internally, submit it through your sitemap and check indexing in Search Console.\n\n6. Earn credible third-party evidence through relevant press, directories, reviews, expert contributions or independent mentions.\n\n7. Run the same test again next month.\n\nYou can check out the more in depth version on Studiobaggio.ai → [guide to Generative Engine Optimisation for Professional Services](/insights/generative-engine-optimisation).\n"
  },
  {
    slug: "ai-set-up-guide",
    title: "AI Set Up Guide",
    category: "AI Adoption",
    categorySlug: "ai-adoption",
    tags: ["AI setup", "CLAUDE.md", "AGENTS.md", "Claude", "Codex", "AI skills", "MCP", "AI adoption"],
    source: "Studio Baggio original",
    sourcePath: "/Users/jaymebaggio/Desktop/Studio Baggio/Content/AI_Setup_Guide.md",
    sourceStart: "This is the full set up, in the order I'd build it in if I were starting again from scratch.",
    readTime: "6 min read",
    date: "2026-08-03",
    updated: "2026-08-03",
    summary: "This is the full set up, in the order I'd build it in if I were starting again from scratch.",
    preview: "This is the full set up, in the order I'd build it in if I were starting again from scratch. One folder, a handful of files, your tools connected, and your processes saved as skills.",
    thesis: "This is the difference between an AI that knows your business and one that knows your business today.",
    metaTitle: "AI Set Up Guide | Studio Baggio",
    metaDescription: "The full AI set up, in the order to build it: CLAUDE.md, USER.md, NOW.md, STATUS.md, memory.md, connected tools and skills — with the prompt that builds it with you.",
    related: [
      "3x-documents-10x-ai-effectiveness",
      "what-is-an-ai-skill",
      "firecrawl-for-business"
    ],
    sourceMarkdown: "# AI Setup Guide\n\nThis is the full setup, in the order I'd build it in if I were starting again from scratch.\n\n## One folder for everything\n\nEverything in AI comes back to files in folders. I went through a phase of building a separate setup for every part of the business. A marketing one, a finance one, a content one. Felt organised. Was a nightmare.\n\nEvery job made me pick a folder first, and half of them crossed over anyway.\n\nNow it's one folder- my desktop, more by accident to begin with than by design, but it's become the operating system. Everything happens inside it.\n\nIn the desktop folder, I have a folder for each Project → one per business, one called personal, and one called active for the odd jobs that don't belong anywhere yet.\n\nDon't spend an afternoon designing this. It grows as you use it.\n\n## CLAUDE.md or AGENTS.md: The file the agent reads automatically when opening any folder\n\nInside your main folder, you should have a file called CLAUDE.md or AGENTS.md. These are the same thing but Claude makes it difficult by having its own name vs the standard agents.md used by Codex and other LLMs.\n\nAsk Claude or Codex to make it and it will interview you about the business and optimise the setup- then write the file from your answers. It's the agent's guide to everything else in your system.\n\n.md- means 'markdown' file type. If you haven't come across it, it is a plain text file with basic formatting. Headings, bullets, bold. That's all it is. Same as Word .docx files or .pdf.\n\nThis file matters because it's read automatically at the start of every session. You never have to remember to mention it, Claude or Codex will read it every time.\n\nIt includes what's true regardless of the job → who you are, what the business is and the rules to work under. For example, mine tells Claude to add the CLAUDE.md file and a STATUS.md to all new projects- so regardless of what I'm working on it's always up to date.\n\nKeep it tight. It loads into every job you run, so a bloated one eats your context memory before you've even started a session. It should be a tight map to the headlines and everything else it needs to reference. Nothing else.\n\n## USER.md: everything about you and the business\n\nYour CLAUDE.md holds how you work. This holds what you do, who you are, what the business does, who your clients are, how you sound, what you sell and what it costs.\n\nYour CLAUDE.md should point at it → everything about me and the business is in USER.md, read it before you start.\n\nTake time getting this one right & when it gets too long, split it into a folder called context. A file each for you, the business, your clients, how you sound. Point CLAUDE.md at the folder instead of the file.\n\nKeep clients out of it. USER.md is about you, and it loads on every job.\n\nEach client gets their own folder with their own context in it. That way you're not carrying a specific client's brand guidelines around while you write your own newsletter.\n\n## NOW.md: what's true this week\n\nEverything so far is durable. Still right in six months.\n\nBut that's not helpful for the live stuff you're working on this week or deals you have in the pipeline.\n\nKeep one short file called NOW.md. Live state → what you're working on, which deals are live, what changed, what you're waiting on.\n\nIn your CLAUDE.md, you should have a line telling Claude to update NOW.md when status of a live project changes- if NOW.md disagrees with anything older, NOW.md is right.\n\nKeep it to a page → if a section grows past a couple of sentences, that detail belongs with the project it came from.\n\nThis is the difference between an AI that knows your business and one that knows your business today.\n\n## STATUS.md: where each project has got to\n\nClaude should know to add a STATUS.md to every project folder.\n\nWhere that piece of work has got to, what's agreed, what's next, what you're waiting on, what you decided and why you decided it.\n\nTell Claude to update it as you work. You're not writing these by hand. They get written as a side effect of doing the job.\n\nThe rule that keeps it clean → one line per project in NOW.md, the detail in that project's STATUS.md. If NOW.md starts getting long, detail has crept into the wrong file.\n\n## memory.md: so you don't repeat corrections\n\nIn your CLAUDE.md there should be one line which says →\n\n'when I correct you, write the lesson into memory.md as a rule, and check that file before every job.'\n\nSay \"stop signing off emails like that\" once, and the memory stops it happening again.\n\nBoth Claude & Codex have their own memory built in now- but you can ask to see it and they will pull it up for you. I have a scheduled upload to Dropbox for this and the others in case I ever lose my laptop or something gets deleted so I know it's always there.\n\nTop Tip: Ask Claude or Codex to review the memory and clear it out every few months or the rules start contradicting each other.\n\n## Connecting your tools\n\nAn agent with no access can only talk to you.\n\nConnecting to external tools runs through something called an API or an MCP → a translator that lets your agent talk to other software- you don't need to know how.\n\nYou can connect to the vast majority of these in the settings section of Codex or Claude (it's as simple as a toggle and a sign in) or you can search for the API or MCP manually - or just ask Claude to do it for you. The ones I can't live without are Firecrawl search & scrape (see [last month's article](/insights/firecrawl-for-business)) Perplexity, Higgsfield for access to most image & video models.\n\n## Skills: your SOPs *Standard Operating Procedures\n\nA skill is a written process the agent follows for a specific task. Nothing more than the step-by-step process and expectations doc you'd write for a new assistant.\n\nEach skill is just a folder with a file in it. The file has three parts → a name, one line on when to use it, and the steps. That one-line description is important- the agent doesn't carry all your skills around from thread to thread. It sees the names and descriptions like spines on a bookshelf, and pulls the right one down when the job calls for it. This process works most of the time without you needing to ask, but you can also 'invoke' skills by using a / command which triggers it to be used.\n\nThere's a tonne of skills out there to try- most are totally free and accessible on GitHub (where developers store and share code). People publish them on GitHub and stars tell you which ones are worth downloading. Here are the highest leverage ones I'd take with me if I could only have a few:\n\n- **/firecrawl**: reads whole websites properly, not just search results. Point it at a competitor and you have their pricing, positioning and claims in a document in seconds.\n- **/impeccable**: reviews and improves any web page or interface. It tells you what's wrong with it and then fixes it.\n- **/emil-design-eng**: the detail layer on anything you build. Spacing, motion and the small things that make something feel considered rather than assembled.\n- **/visual-hierarchy**: makes a page read in the right order, so what matters most is what gets seen first.\n- **/handoff**: hands a long session over to a fresh one without losing the thread. For when a conversation has run all day and started to wander.\n- **/email-voice**: writes emails in your own voice. Build one for any voice you write in regularly and you never start from a blank page again.\n\nWhich brings us on nicely to how to build a skill…\n\n## How to build a skill: think of training a new team member\n\n**Do the job together.**\n\n**Save the steps.**\n\n**Ask them to try.**\n\n**Refine until they get it right every time.**\n\n**Lock it in.**\n\nEveryone assumes you sit and write these upfront. I never do.\n\nDo a job start to finish with it once, correcting as you go. Then say → 'save that as a skill so we can do the same next time.' It builds the skill file for you- key process points, corrections and tools included.\n\nThe first version won't be right. Mine are sometimes infuriatingly difficult to nail. Get to 80% and the rest comes from reps → when something's off, tell it what's off and update the skill.\n\nLike training a new employee, it's a time investment upfront. Once it's nailed, that job gets done your way every time.\n\nYou'll start to spot that some jobs & processes are just skills stacked together. So make an overarching skill whose steps include the smaller skills. That's all an automated workflow is.\n\n## Sharing and managing skills with your team\n\nBuilding great skills for repeatable work is where you unlock real leverage for your team.\n\nA contracting skill, a proposal deck skill, your company brand voice or brand guide- these need to be consistent and available across the team. Over time- the aim is to download your best people's knowledge into a brain that's accessible to all.\n\nYou should NOT send a skill to someone else and hope for the best- the result will be that their Claude or Codex will inevitably make changes and you will very quickly have a bunch of different versions floating around with no source of truth.\n\nIf you rely on Google Drive or Dropbox that throws in its own issues with a larger scale team symlinks and other technical things you don't need to be aware of.\n\nThen I landed on this: push all of your skills to a GitHub repository and make it a plugin.\n\nYour enterprise setup will give the full organisation that plugin which means you're all sharing the same system.\n\n## The mistake I made\n\nOvercomplicating it. You need simplicity and clarity- you'll find once you've done this once you get to a stage where the system is too complex and nothing works quite as well as it used to. Tell Codex or Claude to review the setup and strip out the crap. I've been anxious every time I've done this and never once have I missed anything that's gone.\n\n## Where to start\n\n> Set up an AI operating system for my business in this folder.\n>\n> Start by interviewing me. One question at a time, until you have enough for a short page on each of these: who I am and what I do, what the business does and how it makes money, who my clients are and what they come to me for, what I sell and what it costs, and how I like things written. Don't write any files until we've finished.\n>\n> Then create four files, using my answers, in plain sentences and my own words. No marketing language.\n>\n> CLAUDE.md — how I work and the rules you follow. Keep it short.\n> USER.md — everything from the interview about me and the business.\n> NOW.md — what's live right now. Start it with a few headings and leave me to fill it in.\n> memory.md — empty, ready for corrections.\n>\n> Put these rules in CLAUDE.md:\n>\n> Read NOW.md before anything else. If it disagrees with another file, NOW.md is right.\n> Everything about me and the business is in USER.md. Read it before you start.\n> When I correct you, write the lesson into memory.md as a rule, and check that file before every job.\n> Give every new project folder its own CLAUDE.md and STATUS.md.\n> Update a project's STATUS.md as we work, without me asking.\n> When a project's status changes, update its line in NOW.md. One line per project there, the detail in STATUS.md.\n>\n> When you're done, show me each file and tell me which lines I should check.\n\nRead what it writes before you keep it. It's building from your answers, so anything slightly off in there gets repeated in everything it does for you afterwards.\n\nConnect two tools you're in every day.\n\nThen try to get through a whole working day just doing work through Claude or Codex. It will be slow and painful once but that investment is all that's standing between you and coming out the other side."
  },
  {
    slug: "3x-documents-10x-ai-effectiveness",
    title: "3x documents that can 10x the effectiveness of AI in your business",
    category: "AI Adoption",
    categorySlug: "ai-adoption",
    tags: ["AI adoption", "business context", "ChatGPT", "Claude", "AI setup", "ideal customer profile"],
    source: "Studio Baggio original",
    sourcePath: "/Users/jaymebaggio/Desktop/Studio Baggio/Content/Piece_1_Three_Documents.md",
    sourceStart: "These three documents can supercharge your output",
    readTime: "4 min read",
    date: "2026-07-28",
    updated: "2026-07-28",
    summary: "These three documents can supercharge your output- they should be one page each, in plain English.",
    preview: "These three documents can supercharge your output- they should be one page each, in plain English. What the business does, who you serve, and how you work.",
    thesis: "AI is only as good as what it knows about your business.",
    metaTitle: "3x documents that can 10x the effectiveness of AI in your business | Studio Baggio",
    metaDescription: "The three documents that give AI the context it needs: what your business does, who you serve, and how you work. With examples to copy and the prompt that writes them.",
    related: [
      "chatgpt-for-business-owners",
      "ai-adoption-value-gap",
      "what-is-an-ai-skill"
    ],
    sourceMarkdown: "# 3x documents that can 10x the effectiveness of AI in your business\n\nThese three documents can supercharge your output- they should be one page each, in plain English.\n\n### 1. What the business does\n\n> Studio Baggio is an AI consultancy run by Jayme Baggio.\n>\n> We build AI systems for trust-based businesses - law firms, wealth managers, professional services.\n>\n> The work is practical: find where AI creates value in a business, build it in, and make sure people use it.\n>\n> Clients come through referrals and through what we publish.\n>\n> This year's priority is client delivery over new products.\n\nWrite it how you'd say it, not how your website says it.\n\n### 2. Who you serve\n\n> Our clients are senior people at established firms - partners, founders, managing directors.\n>\n> They know AI matters and don't have time to figure it out from scratch.\n>\n> The questions they ask most: where do we start, what shouldn't we automate, is our data safe.\n>\n> They want a straight answer first, then the detail if they ask.\n>\n> Good service means plain English, no hype, and systems their teams end up using.\n\nThis is the most important one. Everything the AI writes for you is aimed at these people.\n\n### 3. How you work\n\n> Write in plain English. No jargon, no marketing language.\n>\n> No line goes in for the sake of it. If it doesn't need to be there, take it out.\n>\n> Emails open with the answer, then the detail.\n>\n> Client names stay confidential unless we have written permission.\n>\n> If unsure, say so. Never guess.\n\nAnything you keep correcting in other people's work goes in here.\n\n## How to write yours\n\nOpen ChatGPT or Claude and paste this:\n\n> Ask me questions, one at a time, to build three documents about my business: 1) what the business does, 2) who we serve, 3) how we work.\n>\n> Keep asking until you have enough for one page on each. Then write all three in short plain sentences, exactly as I said them, with no marketing language added.\n\nAnswer its questions and you'll end up with all three drafts. Then read every line and fix anything that's wrong, because a wrong line gets repeated in everything it writes for you afterwards.\n\n## Where to put them\n\nIn ChatGPT or Claude, create a Project, add the three files, and work inside it. Every request then starts with the AI already knowing your business. Keep your own copies in a normal folder too, so you still have them if you ever switch tools.\n\n## What changes\n\nAsk for an email, a proposal or a client explainer, and what comes back sounds like your business.\n\nYou'll still edit, just a lot less. Update the documents when your prices or services change."
  },
  {
...
Around half of Google searches now show an AI summary, heading past 75% by 2028, and most people who use AI search say it's now their main way of deciding who to buy from (McKinsey, August 2025). Capgemini's consumer research puts it more starkly: 58% of consumers have already replaced traditional search engines with AI when deciding what to buy and who to use (Capgemini, January 2025).
