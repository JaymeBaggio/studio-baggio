  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "The AI runs searches, reads what already ranks- rankings, directories, press, reviews, \"best of\" lists- and names the firms the public web agrees on. It favours names it can verify in more than one place, and nearly half of what it cites is earned coverage rather than your own site."
      },
      {
    ...
    sourceMarkdown: "# How to master SEO & AI search in 2026\n\n58% of consumers have already replaced traditional search engines with AI when deciding what to buy and who to use (Capgemini). Your next client is more than likely one of them-asking ChatGPT who they should choose instead of scrolling through a list of links on Google.\n\n> **Try it yourself** → open ChatGPT and ask \"who's the best [what you do] in [where you're based]?\"\n\nIf your name comes up- that's a major advantage… If it doesn't, that's fixable, and fixing it is simple once you've seen how AI answers are built…\n\n## What happens when someone asks AI for a recommendation\n\nSay a business owner types this into ChatGPT → \"Who's the best financial advisor for business owners in London?\"\n\nThe AI doesn't have a list of financial advisors officially ranked and stored. So it runs a selection of searches on your behalf- \"best financial advisors london\", \"London financial advisor reviews\", \"financial advisors for entrepreneurs compared\"- and reads the pages that come up: rankings, directories, press, reviews, \"best of\" lists.\n\nWay more firms come up than one answer can hold, so here's how it picks…\n\n**Corroboration.** The AI favours names it can verify in more than one place. If 3x independent sources name the same company, it is far more likely to get named- one glowing page of your own counts for little.\n\n**Evidence.** Nearly half of what AI cites is earned- press, reviews, directories, independent lists. What others publish about you outweighs what you say about yourself.\n\n**Consistency.** The AI builds one picture of you from every page it reads. If your name, description and services match everywhere, you're easy to recommend. If they clash, it moves on.\n\n**Memory.** ChatGPT also carries a memory from training, so businesses mentioned consistently for years get recognised even before it searches.\n\n**Sources.** The engines read differently- Perplexity and Google's AI answers draw almost entirely from what ranks on Google, ChatGPT searches through Bing, and all of them pull heavily from Reddit threads and LinkedIn posts.\n\nThen it answers. The person never sees a list of links. They see \"consider [firm]\", with a handful of sources underneath- and the firms named are the ones the public web agrees on.\n\nThe industry calls the work of getting into those answers GEO, AEO, AI SEO or AI search visibility. These are all the same thing- ignore the jargon.\n\n## What that means for your business\n\nSEO still matters. The AI builds its answers from what already ranks in search- Google for some engines, Bing for ChatGPT- so everything you've done to rank is now the raw material for AI answers too. None of that work is wasted.\n\nThe AI can only recommend what it can read. Your reputation- great clients, referrals, word of mouth- lives in private conversations. The AI has no idea any of it exists, so it skips you because there isn't any evidence of your expertise.\n\n## Why AI Search is so effective: prospects come in pre-qualified\n\nA visitor from Google clicked a link. A visitor from an AI answer had a conversation first- they asked about fees, fit, alternatives and their specific circumstances, and the AI recommended you by name.\n\nThat is a referral, not blind traffic. By the time they land on your site they're most of the way to a 'yes'.\n\nA normal website converts 1-2% of visitors. Semrush's data shows visitors arriving from AI answers convert at 4.4 times the rate of organic search.\n\nAnd barely anyone is doing this yet. In finance, the average brand gets cited in roughly 2% of AI answers (Boring Marketing). When we tested 50 real questions about UK financial advice across the main AI assistants, a small group of firms dominated the answers and plenty of household names barely appeared.\n\n## How to get named\n\n- Answer real questions on your site → plainly, near the top of the page. AI quotes clean, self-contained answers. Buried points never get read.\n\n- Be specific and name your sources → \"many firms see results\" gets skipped. A named figure from a named source gets quoted.\n\n- Make it readable by machines → headings that match the questions buyers actually ask, an FAQ section, and schema (a behind-the-scenes label that tells machines what each part of a page is- ask Claude or Codex to add it for you).\n\n- Get mentioned in places you don't own → nearly half of what AI cites is press, directories, roundups, reviews, Reddit and independent lists. The AI reads the lists other people wrote about your market, so the more of them you're on, the more often you're the answer. This is the single biggest lever: Ahrefs studied 75,000 brands and found mentions track AI visibility three times more closely than backlinks.\n\n- Keep your details consistent everywhere → same name, same description, same services across your site, LinkedIn, your Google Business Profile and every listing, so the AI builds one coherent picture of you. For local searches the AI leans heavily on your Google Business Profile and its reviews- keep both current.\n\n- Check monthly → ask ChatGPT and Perplexity the questions your buyers would ask, and log whether you appear.\n\n## What not to do\n\nThere are agencies selling shortcuts- paying list owners for placements, networks of AI-generated pages. Some of it works, until a model update changes how answers get built and the traffic disappears overnight. That has already happened to businesses that bet everything on it.\n\nGoogle's own guidance now says to treat anyone guaranteeing AI rankings as a red flag. Earn the mentions instead, and treat AI search as one channel of several, never the only one.\n\n## How to start:\n\n1. Build your question list. Ask \"who's the best [what you do] in [your city]?\" in Perplexity (free at perplexity.ai)- under each answer it lists the related questions real people ask. Follow the trail and write them all down.\n\n2. Check where you stand. Run the list through ChatGPT and Perplexity and note where your name comes up and where it doesn't. The gaps are your to-do list.\n\n3. Fix the biggest gap first. Write one page that plainly answers it, then go after the lists and directories that ranked instead of you.\n\nThe deeper version- how AI decides who to cite and the full fix- is in our guide to [Generative Engine Optimisation for Professional Services](/insights/generative-engine-optimisation).\n"
  },
  {
