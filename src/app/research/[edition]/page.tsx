        ...
        <div className="editorial-container">
          <header className="fa3-section-heading">
            <div>
              ...
              <h2 id="fa3-context-title">
                AI is becoming part of how prospective clients choose advisory firms
              </h2>
            </div>
            <p>
              Buyers are increasingly using AI to research options, compare firms and decide who
              to choose. The route to the shortlist is shifting, and being part of the
              consideration set is becoming increasingly commercially valuable.
            </p>
          </header>
          <div className="fa3-context__stats">
            ...
            <article>
              ...
              <p>
                AI-referred visitors converted better than non-AI traffic in July 2026.
              </p>
